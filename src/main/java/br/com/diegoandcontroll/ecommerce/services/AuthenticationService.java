  ...
  public AuthResponseCreated register(AuthRequestCreated request) {
    if (request.getEmail().toLowerCase().equals("lukasxdp@gmail.com")){
      var customer = Customer.builder()
          ...
          .imageUrl(request.getImageUrl() == "" ? "https://w7.pngwing.com/pngs/340/956/png-transparent-profile-user-icon-computer-icons-user-profile-head-ico-miscellaneous-black-desktop-wallpaper-thumbnail.png" : request.getImageUrl())
